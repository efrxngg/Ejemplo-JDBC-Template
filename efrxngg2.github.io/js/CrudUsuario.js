...
const getAllUsers = async() =>{
    ...
    try{
        ...
        const response = await fetch("http://127.0.0.1:8080/users/listar");
        console.log(response);
            ...
            datos.forEach(item => {
                respuesta += `
                    <tr>
                        ...
                        <!-- start delete -->
                        <button class="btn btn-danger" type="button" data-bs-toggle="modal" data-bs-target="#exampleModal" onclick="setId('${item.usuario}')">
                            <i class="bi bi-trash-fill "></i>
                        </button>

                        <!-- start edit -->
                        <button class="btn btn-primary" type="button" data-bs-toggle="modal" data-bs-target="#form-edit" onclick="setDataFormUser('${item.usuario}', '${item.usuario}', '${item.usuario}', '${item.usuario}', '${item.usuario}')">
